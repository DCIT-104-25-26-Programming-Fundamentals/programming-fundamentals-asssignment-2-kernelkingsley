    ...
    while (keepRunning)
    {
        ...
        if (choice >= 1 && choice <= 6)
        {
            ...
            else if (choice == 5)
            {
                ...
                {
                    cout << "Result: " << firstNumber << " % " << secondNumber << " = " << modulus((int)firstNumber, (int)secondNumber) << endl;
                }
            }
            else if (choice == 6)
            {
                cout << "Result: " << firstNumber << " ^ " << secondNumber << " = " << exponent(firstNumber, secondNumber) << endl;
            }
        }
        else if (choice == 7)
        {
